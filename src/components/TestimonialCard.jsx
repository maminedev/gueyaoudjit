const TestimonialCard = ({ testimonial }) => {
  return (
    <div className="col-span-1 p-10 bg-black border border-white border-opacity-10 rounded-xl testimonial-card">
      ...
      <div className="flex md:flex-row flex-col md:items-center justify-between md:mt-20 mt-10">
        <div>
          <h1 className="text-white md:text-3xl text-lg font-medium mb-1">
            {testimonial.name}
          </h1>
